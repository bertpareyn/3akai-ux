                ...
                if (!value) {
                    ...
                    $.each(selectedFiles, function(index, file) {
                        if (file.displayName === prevValue) {
                            ...
                            $listItemContainer.find('.btn.upload-trash').attr('data-id', value);
        ...
        var initUpload = function() {
            ...
            $('#upload-doupload').off('click').on('click', function() {
                ...
                var doUpload = function(file) {
                    if (file) {
                        $('div[data-id="' + file._id + '"] .icon-spinner', $rootel).show();
                        oae.api.content.createFile(file.displayName, file.description, file.visibility, $('#upload-input'), file.file, [], file.viewers, function(error, data) {
                            $('div[data-id="' + file._id + '"] .icon-spinner', $rootel).hide();
                            if (!error) {
                                $('div[data-id="' + file._id + '"] .icon-ok', $rootel).show();
                            } else {
                                $('div[data-id="' + file._id + '"] .icon-warning-sign', $rootel).show();
                            }
