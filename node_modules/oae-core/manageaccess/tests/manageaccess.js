casper.echo('Widget - manageaccess', 'INFO');
...
var verifyOpenManageAccess = function() {
    casper.waitForSelector('#group-clip-container .oae-clip-content button', function() {
        casper.test.assertExists('#group-clip-container .oae-clip-content button',
            'The button for the group clip container is present.');
        ...
        casper.waitForSelector('button.group-trigger-manageaccess', function() {
            casper.test.assertExists('button.group-trigger-manageaccess',
                'The trigger for the manageaccess is present.');
...
var verifyAddUser = function(username) {
    ...
    casper.waitForSelector('#manageaccess-share-add-more', function() {
        ...
        casper.waitForSelector('.as-selections', function() {
            casper.test.assertExists('#manageaccess-share .as-selections input',
                'The input field for the add user in manageaccess is present.');
            casper.test.assertExists('#manageaccess-share-role',
                'The dropdown list for the role in the add user in manageaccess is present.');
            ...
            casper.waitForSelector('.as-list li', function() {
                casper.test.assertExists('.as-list li', 
                    'There exists at least one user that matches the user to add in manageaccess.');
                casper.test.assertExists('#manageaccess-share-update',
                    'The save button to add the user in manageaccess is present.')
 ...
 *
 * @param   {String}    type    The type the visibility is changed to
 *                              can be 'private', 'loggedin' and 'public' else public will be used
 *
