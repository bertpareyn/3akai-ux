...
var verifyDeleteDiscussions = function(discussion){
    casper.thenOpen('http://test.oae.com/me/discussions', function() {
        casper.waitForSelector('.oae-list-grid', function() {
            ...
            casper.test.assertExists('.oae-list-grid>li:nth-child(2) a[title="' + discussion.displayName + '"]',
                'The discussion that is gonna be removed exists.');
            casper.test.assertExists('.oae-list-grid>li:nth-child(2) input[type="checkbox"]',
                'The checkbox for the discussion that needs to be removed exists.');
            ...
            casper.waitForSelector('#discussionslibrary-widget button.oae-trigger-deleteresources', function() {
                ...
                casper.waitForSelector('button#deleteresources-manage-delete-system', function() {
                    casper.test.assertExists('#deleteresources-overview-container a[title="' + discussion.displayName + '"]',
                        'The right discussion has been chosen for removing.');
                    casper.test.assertExists('button#deleteresources-manage-delete-system',
                        'The delete from system button is present.');
                    casper.test.assertExists('button#deleteresources-manage-delete-system',
                        'The delete from library button is present.');
                    ...
                    casper.waitForSelector('#oae-notification-container > .alert-success', function() {
                        ...
                        casper.test.assertExists('#oae-notification-container > .alert-success',
                            'The deletion of the discussion was a success.');
                    });
                });
            });
        });
...
var verifyDeleteDocuments = function(document){
    casper.thenOpen('http://test.oae.com/me/library', function() {
        casper.waitForSelector('.oae-list-grid', function() {
            ...
            casper.test.assertExists('.oae-list-grid>li:nth-child(2) a[title="' + document.displayName + '"]',
                'The document that is gonna be removed exists.');
            casper.test.assertExists('.oae-list-grid>li:nth-child(2) input[type="checkbox"]',
                'The checkbox for the document that needs to be removed exists.');
            ...
            casper.waitForSelector('#contentlibrary-widget button.oae-trigger-deleteresources', function() {
                ...
                casper.waitForSelector('button#deleteresources-manage-delete-system', function() {
                    casper.test.assertExists('#deleteresources-overview-container a[title="' + document.displayName + '"]',
                        'The right document has been chosen for removing.');
                    casper.test.assertExists('button#deleteresources-manage-delete-system',
                        'The delete from system button is present.');
                    casper.test.assertExists('button#deleteresources-manage-delete-system',
                        'The delete from library button is present.');
                    ...
                    casper.waitForSelector('#oae-notification-container > .alert-success', function() {
                    	// Test if the delete was succesfull
                        casper.test.assertExists('#oae-notification-container > .alert-success',
                            'The deletion of the document was a success.');
                    });
                });
            });
        });
...
var verifyDeleteFiles = function(fileUrl){
    casper.thenOpen('http://test.oae.com/me/library', function() {
        casper.waitForSelector('.oae-list-grid', function() {
            // Don't use nth-child(1) that is the start content section
            casper.test.assertExists('.oae-list-grid>li:nth-child(2) a[href="' + fileUrl + '"]',
                'The file that is gonna be removed exists.');
            casper.test.assertExists('.oae-list-grid>li:nth-child(2) input[type="checkbox"]',
                'The checkbox for the file that needs to be removed exists.');
            ...
            casper.waitForSelector('#contentlibrary-widget button.oae-trigger-deleteresources', function() {
                ...
                casper.click('#contentlibrary-widget button.oae-trigger-deleteresources');
                casper.waitForSelector('button#deleteresources-manage-delete-system', function() {
                    casper.test.assertExists('#deleteresources-overview-container a[href="' + fileUrl + '"]',
                        'The right file has been chosen for removing.');
                    casper.test.assertExists('button#deleteresources-manage-delete-system',
                        'The delete from system button is present.');
                    casper.test.assertExists('button#deleteresources-manage-delete-system',
                        'The delete from library button is present.');
                    ...
                    casper.waitForSelector('#oae-notification-container > .alert-success', function() {
                    	// Test if the delete was succesfull
                        casper.test.assertExists('#oae-notification-container > .alert-success',
                            'The deletion of the file was a success.');
                    });
                });
            });
        });
...
var verifyDeleteLinks = function(link){
    casper.thenOpen('http://test.oae.com/me/library', function() {
        casper.waitForSelector('.oae-list-grid', function() {
            // Don't use nth-child(1) that is the start content section
            casper.test.assertExists('.oae-list-grid>li:nth-child(2) a[title="' + link.displayName + '"]',
                'The link that is gonna be removed exists.');
            casper.test.assertExists('.oae-list-grid>li:nth-child(2) input[type="checkbox"]',
                'The checkbox for the link that needs to be removed exists.');
            ...
            casper.waitForSelector('#contentlibrary-widget button.oae-trigger-deleteresources', function() {
                ...
                casper.click('#contentlibrary-widget button.oae-trigger-deleteresources');
                casper.waitForSelector('button#deleteresources-manage-delete-system', function() {
                    casper.test.assertExists('#deleteresources-overview-container a[title="' + link.displayName + '"]',
                        'The right link has been chosen for removing.');
                    casper.test.assertExists('button#deleteresources-manage-delete-system',
                        'The delete from system button is present.');
                    casper.test.assertExists('button#deleteresources-manage-delete-system',
                        'The delete from library button is present.');
                    ...
                    casper.waitForSelector('#oae-notification-container > .alert-success', function() {
                    	// Test if the delete was succesfull
                        casper.test.assertExists('#oae-notification-container > .alert-success',
                            'The deletion of the link was a success.');
                    });
                });
            });
        });
		...
		discussionUtil().createDiscussion(1, function(discussions) {
			...
			casper.then(function() {
				collabDocUtil().createCollabDoc(function(document) {
					...
					var link1 = null;
					casper.then(function() {
						linkUtil().createLink(function(link) {
							link1 = link;
