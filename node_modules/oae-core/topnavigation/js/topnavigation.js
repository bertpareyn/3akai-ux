...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var initTopNavigation = function() {
            ...
            if (oae.data.me.anon) {
                // Adjustments are different for landing page
                if ((window.location.pathname === '/') || (window.location.pathname === '/index')) {
                    $('#topnavigation-left', $rootel).addClass('col-xs-5');
                    $('#topnavigation-left', $rootel).removeClass('col-xs-7');
                    $('#topnavigation-center', $rootel).addClass('col-xs-2 visible-xs');
                    $('#topnavigation-center', $rootel).removeClass('col-xs-0 hidden-xs');
                } else {
        ...
        var setUpSearch = function() {
            ...
            // Topnav search is redundant on landing page (and causes
