...
define(['jquery', 'oae.core', 'jquery.jeditable'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var doReset = function() {
            ...
            $(document).off('oae.trigger.setpermissionschanged');
            $(document).off('oae.trigger.cancelsetpermissions');
            ...
            $('#createlink-visibility-summary', $rootel).html('');
            ...
            // Reset controls
            $('#createlink-overview-container', $rootel).hide();
            $('#createlink-permissions-container', $rootel).hide();
        ...
        var renderAdded = function() {
            oae.api.util.template().render('#createlink-selected-template', {'links': addedLinks}, $('#createlink-selected-container', $rootel));
         ...
         */
        var initSetPermissionsChanged = function() {
            $(document).on('oae.trigger.setpermissionschanged', function(ev, data) {
                ...
                $('#createlink-visibility-summary', $rootel).html(data.summary);
                // Switch back to the overview
                showOverview();
            });

            $(document).on('oae.trigger.cancelsetpermissions', function(ev) {
                showOverview();
            });
        };
        ...
        var showPermissions = function() {
            ...
            $('#createlink-container > .modal-footer', $rootel).hide();
        ...
        var showOverview = function() {
            ...
            $('#createlink-container > .modal-footer', $rootel).show();
        ...
        var initLinkCreation = function() {
            $('#createlink-docreate', $rootel).off('click').on('click', function() {
                var done = 0;
                ...
                $('#createlink-docreate', $rootel).attr('disabled', 'disabled');
                    ...
                    if (link) {
                        ...
                        oae.api.content.createLink(link.displayName, link.description, visibility, link.link, [], link.viewers, function(error, data) {
                            ...
                            if (done !== addedLinks.length) {
                                ...
                                updateProgress(100);
                                $('#createlink-docreate', $rootel).hide();
                                $('#createlink-container', $rootel).modal('hide');
                            }
                        });
                    }
                };
        ...
        var initLinkModal = function() {
            $(document).on('click', '.oae-trigger-createlink', function() {
                ...
                initSetPermissionsChanged();
            });

            // Binds the 'change' button that shows the setpermissions widget
            $('#createlink-change-permissions', $rootel).on('click', function() {
                showPermissions();
            });
        };
