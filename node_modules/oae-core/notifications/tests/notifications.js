...
var verifyPostToDiscussion = function(user, discussion, n){
	...
	casper.test.assertSelectorHasText('#notifications-container li:nth-child(' + n + ') a', discussion.displayName,
	...
	casper.test.assertExists('#notifications-container li:nth-child(' + n + ') a[href="' + discussion.profilePath + '"]',
		'The link to the discussion from the notification of posted to the discussion is present');
};
